...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2015, 11, 1) and C.drug_exposure_start_date <= DATEFROMPARTS(2020, 12, 31))
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2015, 11, 1) and C.condition_start_date <= DATEFROMPARTS(2020, 12, 31))
-- End Condition Occurrence Criteria
...
WHERE (C.observation_date >= DATEFROMPARTS(2015, 11, 1) and C.observation_date <= DATEFROMPARTS(2020, 12, 31))
...
select @target_cohort_id as cohort_definition_id, person_id, CASE WHEN start_date > DATEFROMPARTS(2015, 11, 1) THEN start_date ELSE DATEFROMPARTS(2015, 11, 1) END, CASE WHEN end_date < DATEFROMPARTS(2020, 12, 31) THEN end_date ELSE DATEFROMPARTS(2020, 12, 31) END 
FROM #final_cohort CO
WHERE CASE WHEN start_date > DATEFROMPARTS(2015, 11, 1) THEN start_date ELSE DATEFROMPARTS(2015, 11, 1) END <= CASE WHEN end_date < DATEFROMPARTS(2020, 12, 31) THEN end_date ELSE DATEFROMPARTS(2020, 12, 31) END
;
