...
inputValues <- data.frame("serverDatabaseId"=c("truven_ccae",
                           ...
                           "cdmDatabaseSchema"=c("cdm_truven_ccae_v1676",
                                                    ...
                                                    "cdm_jmdc_v1678"),
                           "cohortTable"=c("HERMES_p4v2_TruvenCCAE",
                                              "HERMES_p4v2_OptumDOD",
                                              "HERMES_p4v2_TruvenMDCD",
                                              "HERMES_p4v2_OptumEHR",
                                              "HERMES_p4v2_PharmetricsPlus",
                                              "HERMES_p4v2_TruvenMDCR",
                                              "HERMES_p4v2_JMDC"),
...
for (i in 2:nrow(inputValues)) { # i <- 7
