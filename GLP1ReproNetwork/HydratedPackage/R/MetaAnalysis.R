...
synthesizeResults <- function(allDbsFolder,
  ...
  results <- ParallelLogger::clusterApply(cluster, groups, HERMESp4Hydra:::computeGroupMetaAnalysis, method, addTraditional)
...
computeGroupMetaAnalysis <- function(group, method, addTraditional) {
  ...
  outcomeGroupResults <- lapply(outcomeIds, HERMESp4Hydra:::computeSingleMetaAnalysis, group, method, addTraditional)
