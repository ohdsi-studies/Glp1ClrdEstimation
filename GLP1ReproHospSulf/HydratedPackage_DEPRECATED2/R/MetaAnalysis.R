...
synthesizeResults <- function(allDbsFolder,
  ...
  results <- ParallelLogger::clusterApply(cluster, groups, HERMESp1bHydra:::computeGroupMetaAnalysis, method, addTraditional)
...
computeGroupMetaAnalysis <- function(group, method, addTraditional) {
  ...
  outcomeGroupResults <- lapply(outcomeIds, HERMESp1bHydra:::computeSingleMetaAnalysis, group, method, addTraditional)
