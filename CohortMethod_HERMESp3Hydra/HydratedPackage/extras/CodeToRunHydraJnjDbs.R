...
#cohortTable <- "HERMES_p3_OptumEHR" #Revise cohortTable name to refer to the specific DB being run
#cohortTable <- "HERMES_p3_PharmetricsPlus" #Revise cohortTable name to refer to the specific DB being run
#cohortTable <- "HERMES_p3_TruvenMDCR" #Revise cohortTable name to refer to the specific DB being run
cohortTable <- "HERMES_p3_JMDC" #Revise cohortTable name to refer to the specific DB being run
