...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1518254,975125,1551099,1506270,1550557,19027186,1507705)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1518254,975125,1551099,1506270,1550557,19027186,1507705)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (252235,253954,255848,256896,257775,258335,261774,318459,4112824,4266367,46269706)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (252235,253954,255848,256896,257775,258335,261774,318459,4112824,4266367,46269706)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (257907,255084,317109,4173177,313590,259992,4195452,45763749,4148529,4148486,4060429,4317960,434271,258333,253235,46269954,4112820,260041)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (255084,317109,4173177,313590,259992,4195452,45763749,4148529,4148486,4060429,4317960,434271,258333,253235,46269954,4112820,260041)
  and c.invalid_reason is null
...
WHERE C.condition_type_concept_id  in (38000184,38000200,38000215,38000230,45756835,45756843,38000183,38000199,44786627,44786628)
...
WHERE C.condition_status_concept_id in (32901,32902,32903,4307107)
-- End Condition Occurrence Criteria
...
WHERE C.condition_type_concept_id  in (38000183,38000199,44786627)
-- End Condition Occurrence Criteria
...
WHERE (C.days_supply >= 1 and C.days_supply <= 14)
