...
outputFolder <- "D:/StudyResults/GLP1Repro/CohortMethod/HERMESp2Hydra"
...
cohortTable <- "HERMESp2Hydra_v2_TruvenCCAE" #Revise cohortTable name to refer to the specific DB being run
