...
WHERE C.condition_type_concept_id  in (38000180,38000200,38000220,38000230,45756840,45756840,38000180,38000200,44786630,44786630)
...
WHERE C.condition_type_concept_id  in (38000180,38000200,44786630)
-- End Condition Occurrence Criteria
