...
outputFolder <- "D:/StudyResults/GLP1Repro/CohortMethod/HERMESp1bHydra"
...
cohortTable <- "HERMESp1bHydra_v1_TruvenCCAE" #Revise cohortTable name to refer to the specific DB being run
