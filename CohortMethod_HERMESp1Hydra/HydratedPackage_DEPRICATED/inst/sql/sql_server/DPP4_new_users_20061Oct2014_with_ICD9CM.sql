...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2006, 1, 1) and C.drug_exposure_start_date <= DATEFROMPARTS(2014, 10, 1))
...
WHERE (C.drug_exposure_start_date >= DATEFROMPARTS(2005, 1, 1) and C.drug_exposure_start_date <= DATEFROMPARTS(2014, 10, 1))
-- End Drug Exposure Criteria
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2005, 1, 1) and C.condition_start_date <= DATEFROMPARTS(2014, 10, 1))
...
WHERE (C.observation_date >= DATEFROMPARTS(2005, 1, 1) and C.observation_date <= DATEFROMPARTS(2014, 10, 1))
...
WHERE (C.device_exposure_start_date >= DATEFROMPARTS(2005, 1, 1) and C.device_exposure_start_date <= DATEFROMPARTS(2014, 10, 1))
...
select @target_cohort_id as cohort_definition_id, person_id, CASE WHEN start_date > DATEFROMPARTS(2005, 1, 1) THEN start_date ELSE DATEFROMPARTS(2005, 1, 1) END, CASE WHEN end_date < DATEFROMPARTS(2014, 10, 1) THEN end_date ELSE DATEFROMPARTS(2014, 10, 1) END 
FROM #final_cohort CO
WHERE CASE WHEN start_date > DATEFROMPARTS(2005, 1, 1) THEN start_date ELSE DATEFROMPARTS(2005, 1, 1) END <= CASE WHEN end_date < DATEFROMPARTS(2014, 10, 1) THEN end_date ELSE DATEFROMPARTS(2014, 10, 1) END
;
