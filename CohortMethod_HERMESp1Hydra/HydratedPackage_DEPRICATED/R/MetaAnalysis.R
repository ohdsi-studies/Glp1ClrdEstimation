...
synthesizeResults <- function(allDbsFolder,
  ...
  results <- ParallelLogger::clusterApply(cluster, groups, HERMESp1Hydra:::computeGroupMetaAnalysis, method, addTraditional)
...
computeGroupMetaAnalysis <- function(group, method, addTraditional) {
  ...
  outcomeGroupResults <- lapply(outcomeIds, HERMESp1Hydra:::computeSingleMetaAnalysis, group, method, addTraditional)
