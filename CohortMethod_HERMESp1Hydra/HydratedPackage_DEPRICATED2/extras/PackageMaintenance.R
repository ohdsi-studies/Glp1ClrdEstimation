...
OhdsiRTools::checkUsagePackage("HERMESp1Hydra")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/HERMESp1Hydra.pdf")
shell("R CMD Rd2pdf ./ --output=extras/HERMESp1Hydra.pdf")
...
OhdsiRTools::createRenvLockFile("HERMESp1Hydra")
