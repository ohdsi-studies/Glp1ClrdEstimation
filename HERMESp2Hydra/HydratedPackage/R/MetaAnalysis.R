...
synthesizeResults <- function(allDbsFolder,
  ...
  results <- ParallelLogger::clusterApply(cluster, groups, HERMESp2Hydra:::computeGroupMetaAnalysis, method, addTraditional)
...
computeGroupMetaAnalysis <- function(group, method, addTraditional) {
  ...
  outcomeGroupResults <- lapply(outcomeIds, HERMESp2Hydra:::computeSingleMetaAnalysis, group, method, addTraditional)
