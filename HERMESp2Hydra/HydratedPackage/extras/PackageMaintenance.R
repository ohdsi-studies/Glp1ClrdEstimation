...
OhdsiRTools::checkUsagePackage("HERMESp2Hydra")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/HERMESp2Hydra.pdf")
shell("R CMD Rd2pdf ./ --output=extras/HERMESp2Hydra.pdf")
...
OhdsiRTools::createRenvLockFile("HERMESp2Hydra")
