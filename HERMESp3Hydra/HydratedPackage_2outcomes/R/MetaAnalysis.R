...
synthesizeResults <- function(allDbsFolder,
  ...
  results <- ParallelLogger::clusterApply(cluster, groups, HERMESp3Hydra:::computeGroupMetaAnalysis, method, addTraditional)
...
computeGroupMetaAnalysis <- function(group, method, addTraditional) {
  ...
  outcomeGroupResults <- lapply(outcomeIds, HERMESp3Hydra:::computeSingleMetaAnalysis, group, method, addTraditional)
