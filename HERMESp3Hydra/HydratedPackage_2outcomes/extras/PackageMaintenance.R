...
OhdsiRTools::checkUsagePackage("HERMESp3Hydra")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/HERMESp3Hydra.pdf")
shell("R CMD Rd2pdf ./ --output=extras/HERMESp3Hydra.pdf")
...
OhdsiRTools::createRenvLockFile("HERMESp3Hydra")
